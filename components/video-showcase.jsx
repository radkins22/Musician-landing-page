...
const videos = [
  ...
  },
  {
    ...
    description: "A classic polka favorite performed with Reuben's signature style",
    thumbnail: "/images/guitar-blue.jpeg",
  ...
  },
  {
    ...
    description: "A timeless country classic showcasing Reuben's country music expertise",
    thumbnail: "/images/guitar-blue.jpeg",
...
export default function VideoShowcase() {
  ...
  return (
    <section id="videos" className="py-20 bg-gradient-to-b from-red-950 to-black">
      <div className="container px-4 mx-auto">
        <div className="text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-bold mb-4 text-white">Video Showcase</h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          <div className="lg:col-span-2">
            <div className="relative aspect-video bg-black rounded-lg overflow-hidden border-2 border-red-700">
              {activeVideo.videoUrl !== "#" ? (
                <video
                  ...
                  onLoadStart={() => console.log(`Loading video: ${activeVideo.title}`)}
                >
                ...
                <div className="absolute inset-0 flex items-center justify-center">
                  ...
                  <div className="absolute inset-0 bg-black/40 flex items-center justify-center">
                    <div className="text-center">
                      <h3 className="text-2xl font-bold text-white mb-4">{activeVideo.title}</h3>
                      <Button
                        onClick={togglePlay}
            ...
            <div className="mt-4">
              ...
              <p className="text-red-400 text-sm mb-2">{activeVideo.artist}</p>
            ...
            {videos.map((video) => (
              <div
                ...
                className={`flex gap-4 p-3 rounded-lg cursor-pointer transition-colors ${
                  activeVideo.id === video.id ? "bg-red-900/50 border-l-4 border-red-500" : "hover:bg-red-900/30"
                }`}
